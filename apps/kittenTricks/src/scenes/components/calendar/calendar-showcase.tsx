...
import { Button, Calendar, CalendarProps, Divider } from '@meow-ui/components';
...
export const CalendarShowcase = ({
  withFooter,
  ...props
}: CalendarProps & AdditionalProps): React.ReactElement => {
  ...
  const renderFooterElement = (): React.ReactElement => (
    <React.Fragment>
      ...
      <View style={styles.footerContainer}>
        <Button onPress={onTodayPress}>Today</Button>
      </View>
    </React.Fragment>
  );
