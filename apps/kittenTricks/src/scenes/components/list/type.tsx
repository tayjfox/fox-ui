...
import { ListItemElement } from '@meow-ui/components';
import {
...
const renderListItem = (
  info: ListRenderItemInfo<ListData>,
): ListItemElement => <ListItemShowcase {...info.item} />;

const renderIconListItem = (
  info: ListRenderItemInfo<ListData>,
): ListItemElement => <ListItemIconShowcase {...info.item} />;

const renderAccessoryListItem = (
  info: ListRenderItemInfo<ListData>,
): ListItemElement => <ListItemAccessoryShowcase {...info.item} />;

const renderIconAccessoryListItem = (
  info: ListRenderItemInfo<ListData>,
): ListItemElement => <ListItemIconAccessoryShowcase {...info.item} />;
